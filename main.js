...
async function aiPickBestCard(badData, candidateDocs, excludeList = [], statusCallback = null) {
    ...
    **邏輯二：好事卡與鳥事卡之間「一定」要有主題上的關聯性和邏輯上的關聯性**
    - 舉例，當使用者認為工作分配不公時，最好能找到一張卡片來**「證明這世界還有公道，努力會有回報」**。而不是給出一張吃到好吃下午茶的小確幸好事來彌補疲累(沒有主題關聯性，只是純粹一件好事情)。也不是給出一張感受他人善意的好事卡。
	- 絕對不能只是給出一件無關聯的好事，這樣無法說服使用者。
